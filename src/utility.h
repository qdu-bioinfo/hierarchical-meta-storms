...
string Check_Env(){
    ...
    if (getenv("HierarchicalMetaStorms") == NULL){

        cerr << "Error: Please set the environment variable \"HierarchicalMetaStorms\" to the directory" << endl;
    }

    string path =  getenv("HierarchicalMetaStorms");
    return path;

//    return "/mnt/scc8t/zhangyf/PMFuncComp/PMFuncComp_C/";
}


const long double eps = 1e-10;
const double MAX_INF = 1e10;
